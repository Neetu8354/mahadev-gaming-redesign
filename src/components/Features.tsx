...
const FEATURES = [
  { icon: ShieldCheck, title: "Safe & Verified", desc: "Verified betting IDs, KYC compliant, fully encrypted platform." },
  ...
  { icon: Users, title: "Trusted Community", desc: "India's trusted betting community with verified reviews." },
