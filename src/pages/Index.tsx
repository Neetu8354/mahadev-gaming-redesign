  ...
  const jsonLd = [
    ...
    },
    {
      ...
      mainEntity: [
        ...
        { "@type": "Question", name: "Is Mahadev Book safe?", acceptedAnswer: { "@type": "Answer", text: "Yes — verified KYC, encrypted transactions, and secure funds. Trusted by Indian players." } },
